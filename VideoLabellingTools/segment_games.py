...
python3 segment_games.py \
  --csv /opt/dlami/nvme/opentt_data/CreateOpenTTScoreLabels/VideoLabellingTools/labels/densified_scores/game_5_scores.csv \
  --out_json /opt/dlami/nvme/opentt_data/CreateOpenTTScoreLabels/VideoLabellingTools/labels/game_segments/game_5_segments.json
